...
image:https://img.shields.io/travis/riboseinc/asciidoctor-metanorma_sample/master.svg["Build Status", link="https://travis-ci.com/riboseinc/asciidoctor-metanorma_sample"]
